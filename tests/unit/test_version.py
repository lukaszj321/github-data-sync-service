...
def test_package_version() -> None:
    assert github_data_sync_service.__version__ == "0.1.0"
    assert version("github-data-sync-service") == "0.1.0"
...
def test_worker_version_output(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert capsys.readouterr().out.strip() == "github-data-sync-worker 0.1.0"
